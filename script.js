...
function switchLanguage(lang) {
    ...
    document.getElementById("navigate-button").innerText = translations[lang].navigateButton;
...
const strategyTable = {
    ...
    "A,6": {2: "H", 3: "D/S", 4: "D/S", 5: "D/S", 6: "D/S", 7: "H", 8: "H", 9: "H", 10: "H", A: "H"},
...
function getAdvice() {
    ...
    let advice = strategyTable[playerHand]?.[dealerCard] || "No advice available.";
    ...
    const translatedAdvice = translations[currentLanguage].adviceTranslations[advice] || translations[currentLanguage].noAdvice;
